...
from agent_runtime import AgentState, AgentStatus, Message, RunSnapshot, RuntimeContext
...
def test_run_snapshot_constructor_copies_state_and_context() -> None:
    ...
    state.messages.append(Message.user_text("mutated"))
...
def test_run_snapshot_accessors_return_copies() -> None:
    ...
    snapshot.state.messages.append(Message.user_text("mutated"))
