...
from kernel.trace import RunTrace, TraceRecorder, TraceStepKinds
...
class AgentLoop:
    ...
    def __init__(
        ...
        *,
        model: ModelClient,
        tools: Sequence[Tool] | ToolRegistryProtocol | None = None,
        ...
        if tools is None:
            ...
            self._tools = ToolRegistry(cast(Sequence[Tool], tools))
    ...
    @staticmethod
    def _is_tool_registry(value: object) -> TypeGuard[ToolRegistryProtocol]:
        return all(
